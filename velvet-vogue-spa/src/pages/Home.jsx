...
import { ShoppingCart, Star, ArrowRight, ArrowUpRight } from 'lucide-react';
    ...
    <div className="relative pb-1">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl space-y-6">
          ...
          <p className="text-neutral-700 text-base sm:text-lg font-medium max-w-md">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Deal 1 */}
        <div 
